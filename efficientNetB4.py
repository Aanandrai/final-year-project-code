...
# ------------ CONFIG --------------
DATA_DIR = r"E:\college final year project\the_app\data\train"  # Update this to your dataset folder
MODEL_PATH = 'best_b4.pth'  # Where to save the model
NUM_CLASSES = 5  # Update this according to your dataset
IMG_SIZE = 380  # Native image size for EfficientNet B4
BATCH_SIZE = 8
LR = 3e-4
EPOCHS = 20
PATIENCE = 5
